<div class="pssbSocialButtons">
    ...
    <!-- Facebook Button -->
    <a class="pssbButton"
       href="https://www.facebook.com/sharer/sharer.php? u=<?php echo $post_url; ?>&amp;picture=<?php echo $social_image; ?>&amp;title=<?php echo $facebook_title; ?>&amp;description=<?php echo urlencode($facebook_description); ?>"
       onclick="javascript:window.open(this.href, '', 'menubar=no,toolbar=no,resizable=yes,scrollbars=yes,height=300,width=600');return false;"
       target="_blank">
