<div class="pssbSocialButtons">
    ...
    <!-- LinkedIn Button -->
    <a class="pssbButton"
       href="https://www.linkedin.com/shareArticle?mini=true&amp;url=<?php echo $post_url; ?>&amp;title=<?php echo urlencode($linkedin_title); ?>&amp;summary=<?php echo urlencode($linkedin_summary); ?>&amp;source=<?php echo get_site_url(); ?>"
       onclick="javascript:window.open(this.href, '', 'menubar=no,toolbar=no,resizable=yes,scrollbars=yes,height=300,width=600');return false;">
    ...
    <!-- Facebook Button -->
    <a class="pssbButton"
       href="https://www.facebook.com/sharer/sharer.php? u=<?php echo $post_url; ?>&amp;picture=<?php echo $social_image; ?>&amp;title=<?php echo urlencode($facebook_title); ?>&amp;description=<?php echo urlencode($facebook_description); ?>"
       onclick="javascript:window.open(this.href, '', 'menubar=no,toolbar=no,resizable=yes,scrollbars=yes,height=300,width=600');return false;"
       target="_blank">
